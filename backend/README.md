...
## Project Structure
    ...
    ├── testapiautocatalog_105935  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_105935`
...
2. Clone this repo and `cd testapiautocatalog_105935`
